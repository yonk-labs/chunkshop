...
> **Note:** This is the actual leaderboard from one verified run of the
> canonical `bakeoff-ntsb.yaml` (12 combos: 3 embedders × 4 chunkers,
> incl. nomic) executed by `chunkshop-rs bakeoff`. Both Python and Rust
> now run the same YAML — `scripts/parity_check_bakeoff.py` verifies the
> two implementations produce equivalent leaderboards (within ±2.5pp MRR;
> consistent ordering on distinct-MRR pairs; top-combo agrees within
> drift tolerance).
...
| 3 | `hierarchy` | `Xenova/bge-base-en-v1.5-int8` | 0.917 | 0.917 | 1.000 | 0.933 |
| 4 | `sentence_aware` | `Xenova/bge-base-en-v1.5-int8` | 0.917 | 0.917 | 1.000 | 0.933 |
| 5 | `neighbor_expand(window=1, base=hierarchy)` | `nomic-ai/nomic-embed-text-v1.5-Q` | 0.917 | 0.917 | 1.000 | 0.933 |
| 6 | `sentence_aware` | `Xenova/bge-small-en-v1.5-int8` | 0.833 | 1.000 | 1.000 | 0.903 |
| 7 | `hierarchy` | `Xenova/bge-small-en-v1.5-int8` | 0.833 | 0.917 | 0.917 | 0.875 |
| 8 | `neighbor_expand(window=1, base=hierarchy)` | `Xenova/bge-base-en-v1.5-int8` | 0.833 | 0.917 | 0.917 | 0.861 |
| 9 | `neighbor_expand(window=1, base=hierarchy)` | `Xenova/bge-small-en-v1.5-int8` | 0.833 | 0.833 | 0.917 | 0.850 |
| 10 | `fixed_overlap(window_words=300, step_words=150)` | `nomic-ai/nomic-embed-text-v1.5-Q` | 0.750 | 0.917 | 1.000 | 0.840 |
...
| `sentence_aware` | `nomic-ai/nomic-embed-text-v1.5-Q` | pilot completed three takeoffs and full stop landings before runway switch | `20080104X00020` | `20080111X00041` | 0.500 |
...
| `hierarchy` | `nomic-ai/nomic-embed-text-v1.5-Q` | pilot completed three takeoffs and full stop landings before runway switch | `20080104X00020` | `20080123X00097` | 0.250 |
...
| `neighbor_expand(window=1, base=hierarchy)` | `nomic-ai/nomic-embed-text-v1.5-Q` | pilot completed three takeoffs and full stop landings before runway switch | `20080104X00020` | `20080102X00005` | 0.200 |
...
| `fixed_overlap(window_words=300, step_words=150)` | `nomic-ai/nomic-embed-text-v1.5-Q` | pilot completed three takeoffs and full stop landings before runway switch | `20080104X00020` | `20080109X00035` | 0.250 |
