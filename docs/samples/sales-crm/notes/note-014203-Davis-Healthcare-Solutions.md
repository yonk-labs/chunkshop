# Sales call note — Davis Healthcare Solutions / ClarityDB Guardian / 2026-02-15
...
Demo and technical discussion with Michael Miller's team. Deep dive into We added an index, and it made other queries slower. and Our dev/test database environments don't match production, so our tests are meaningless.. Their current workaround is manual and error-prone. Davis Healthcare Solutions team receptive to our approach. Building momentum. Will prepare custom demo addressing We added an index, and it made other queries slower..
