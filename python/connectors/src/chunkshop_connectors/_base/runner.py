...
Lifted from RAGFlow's common/data_source/connector_runner.py
(MIT Expat, Onyx-attributed — see ../__init__.py and ../_PROVENANCE.md).
Renamed to runner.py and re-pointed at chunkshop_connectors._base.
"""
import sys
import time
import logging
...
from chunkshop_connectors._base.interfaces import (
    BaseConnector,
...
from chunkshop_connectors._base.models import ConnectorCheckpoint, ConnectorFailure, Document
