...
Lifted verbatim from RAGFlow's common/data_source/interfaces.py
...
# upstream bug fix: RAGFlow's interfaces.py imported BaseModel from the
# anthropic SDK (a clear search-and-replace accident — anthropic doesn't
# export a BaseModel class). pydantic is the actual intended source.
from pydantic import BaseModel

from chunkshop_connectors._base.models import (
    Document,
    KeyRecord,
    SlimDocument,
    ConnectorCheckpoint,
